...
**This MR intends to add new functionalities without changing any existing features.**
...
- [ ] have been tested under multiple configurations, in respect of C & Fortran compatibilities + with & without privatisation.
- [ ] are properly documented thanks to Doxygen (or at least in-place documentation) and Markdown (in `*.md` for major modifications)
- [ ] is reported in the [changelog](CHANGELOG.md)
