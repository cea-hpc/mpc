...
void sctk_set_net_migration_available(){}

void sctk_net_abort(){abort();not_implemented();}

void sctk_register_thread_initial(){}
/* void sctk_unregister_thread(){} */
...
/* void sctk_ptp_per_task_init(){not_implemented();} */
