...
\begin{verbatim}
      gunzip MPC_2.1_rc2.tar.gz
      tar xf MPC_2.1_rc2.tar
      cd MPC_2.1_rc2
\end{verbatim}

\item  Choose an installation directory (the default is \texttt{/usr/local/}):
