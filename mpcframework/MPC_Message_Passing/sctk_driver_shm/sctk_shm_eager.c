...
int
sctk_network_eager_msg_shm_send(sctk_thread_ptp_message_t *msg,vcli_cell_t * __cell,int copy_enabled)
{
    ...
    FAST_MEMCPY( __cell->data, (char*) msg, sizeof ( sctk_thread_ptp_message_t ));       
