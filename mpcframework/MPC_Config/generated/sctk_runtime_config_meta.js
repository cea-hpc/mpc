...
meta.types = {
	...
	net_driver_infiniband : {type: 'struct', name: "net_driver_infiniband", childs: {
		...
		eager_limit: {mode: 'param', name: "eager_limit", type: "size", doc: "Size of the eager buffers (short messages).", dflt: "12288", },
		buffered_limit: {mode: 'param', name: "buffered_limit", type: "size", doc: "Max size for using the Buffered protocol (message split into several Eager messages).", dflt: "262114", },
		...
		max_inline: {mode: 'param', name: "max_inline", type: "size", doc: "Max size for inlining messages", dflt: "128", },
		...
		size_ibufs_chunk: {mode: 'param', name: "size_ibufs_chunk", type: "size", doc: "Number of new buffers allocated when no more buffers are available.", dflt: "100", },
		...
		rdma_min_size: {mode: 'param', name: "rdma_min_size", type: "size", doc: "Defines the minimum size for the Eager RDMA buffers", dflt: "1024", },
		rdma_max_size: {mode: 'param', name: "rdma_max_size", type: "size", doc: "Defines the maximun size for the Eager RDMA buffers", dflt: "4096", },
		...
		rdma_resizing_min_size: {mode: 'param', name: "rdma_resizing_min_size", type: "size", doc: "Defines the minimum size for the Eager RDMA buffers (resizing)", dflt: "1024", },
		rdma_resizing_max_size: {mode: 'param', name: "rdma_resizing_max_size", type: "size", doc: "Defines the maximum size for the Eager RDMA buffers (resizing)", dflt: "4096", },
