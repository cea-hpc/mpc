...
meta.types = {
	...
	net_driver_infiniband : {type: 'struct', name: "net_driver_infiniband", childs: {
		...
		eager_limit: {mode: 'param', name: "eager_limit", type: "size", doc: "Size of the eager buffers (short messages).", dflt: "12KB", },
		buffered_limit: {mode: 'param', name: "buffered_limit", type: "size", doc: "Max size for using the Buffered protocol (message split into several Eager messages).", dflt: "26KB", },
