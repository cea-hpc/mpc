...
void __kmpc_copyprivate(ident_t *loc, kmp_int32 global_tid, size_t cpy_size, void *cpy_data,
...
{  
  ...
  if (*cache == 0)
  {
    ...
    if (*cache == 0)
    {
        ...
        tp_cache_addr = (kmp_cached_addr_t *) ((char*) my_cache + sizeof( void * ) * __kmp_tp_capacity);
