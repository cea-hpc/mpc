...
void __mpcomp_GOMP_critical_start(void)
{
...
void __mpcomp_GOMP_critical_end(void)
{
   sctk_nodebug("[Redirect GOMP]%s:\tBegin",__func__);
...
void __mpcomp_GOMP_critical_name_start(void **pptr)
{
   sctk_nodebug("[Redirect GOMP]%s:\tBegin",__func__);
...
void __mpcomp_GOMP_critical_name_end(void **pptr)
{
   sctk_nodebug("[Redirect GOMP]%s:\tBegin",__func__);
...
void __mpcomp_GOMP_atomic_start(void)
{
   sctk_nodebug("[Redirect GOMP]%s:\tBegin",__func__);
...
void __mpcomp_GOMP_atomic_end(void)
{
   sctk_nodebug("[Redirect GOMP]%s:\tBegin",__func__);
   __mpcomp_atomic_end();
   sctk_nodebug("[Redirect GOMP]%s:\tEnd",__func__);
