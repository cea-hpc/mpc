...
bool mpcomp_GOMP_loop_ordered_runtime_start(long istart, long iend, long incr,
  ...
  bool ret;
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  ret = mpcomp_internal_GOMP_loop_ordered_runtime_start(istart, iend, incr,
                                                        start, end);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
  return ret;
}
...
void mpcomp_GOMP_parallel_loop_guided_start(void (*fn)(void *), void *data,
                                            ...
                                            long chunk_size) {
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  mpcomp_internal_GOMP_parallel_loop_guided_start(fn, data, num_threads, start,
                                                  end, incr, chunk_size);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
}
...
void mpcomp_GOMP_parallel_loop_runtime_start(void (*fn)(void *), void *data,
                                             ...
                                             long end, long incr) {
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  mpcomp_internal_GOMP_parallel_loop_runtime_start(fn, data, num_threads, start,
                                                   end, incr);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
}
...
bool mpcomp_GOMP_loop_static_start(long istart, long iend, long incr,
  ...
  bool ret;
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  ret = mpcomp_internal_GOMP_loop_static_start(istart, iend, incr, chunk_size,
                                               start, end);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
  return ret;
}
...
bool mpcomp_GOMP_loop_guided_start(long istart, long iend, long incr,
  ...
  bool ret;
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  ret = mpcomp_internal_GOMP_loop_guided_start(istart, iend, incr, chunk_size,
                                               start, end);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
  return ret;
}
...
bool mpcomp_GOMP_loop_ordered_static_start(long istart, long iend, long incr,
  ...
  bool ret;
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  ret = mpcomp_internal_GOMP_loop_ordered_static_start(istart, iend, incr,
...
bool mpcomp_GOMP_loop_ordered_dynamic_start(long istart, long iend, long incr,
  ...
  bool ret;
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  ret = mpcomp_internal_GOMP_loop_ordered_dynamic_start(istart, iend, incr,
                                                        chunk_size, start, end);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
  return ret;
}
...
bool mpcomp_GOMP_loop_ordered_guided_start(long istart, long iend, long incr,
  ...
  bool ret;
  sctk_nodebug("[Redirect GOMP]%s:\tBegin", __func__);
  ret = mpcomp_internal_GOMP_loop_ordered_guided_start(istart, iend, incr,
                                                       chunk_size, start, end);
  sctk_nodebug("[Redirect GOMP]%s:\tEnd", __func__);
  return ret;
}
