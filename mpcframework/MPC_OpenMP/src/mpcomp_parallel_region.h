...
void __mpcomp_internal_begin_parallel_region( struct mpcomp_new_parallel_region_info_s*, unsigned arg_num_threads );
...
void __mpcomp_start_sections_parallel_region( void (*) (void *), void *, unsigned, unsigned );

void __mpcomp_start_parallel_dynamic_loop( void (*) (void *), void*, unsigned, long, long, long, long );
void __mpcomp_start_parallel_static_loop( void (*) (void *), void*, unsigned, long, long, long, long );
void __mpcomp_start_parallel_guided_loop( void (*) (void *), void*, unsigned, long, long, long, long );
void __mpcomp_start_parallel_runtime_loop( void (*) (void *), void*, unsigned, long, long, long, long );


/* INLINED FUNCTION */
static inline void __mpcomp_parallel_set_specific_infos( mpcomp_new_parallel_region_info_t* info, void* (*func) (void *), void* data, mpcomp_local_icv_t icvs, mpcomp_combined_mode_t type )
{
...
static inline void 
__mpcomp_save_team_info( mpcomp_team_t * team, mpcomp_thread_t * t ) 
{
  sctk_nodebug( "%s:  saving single/section %d and for dyn %d", __func__, t->single_sections_current, t->for_dyn_current); 
...
static inline void 
__mpcomp_wakeup_mvp( mpcomp_mvp_t* mvp, mpcomp_node_t* n ) 
{
	...
	mvp->threads[0].single_sections_current = mvp->info.single_sections_current_save ;
	mvp->threads[0].for_dyn_current = mvp->info.for_dyn_current_save ;

	sctk_nodebug( "%s: value of single_sections_current %d and for_dyn_current %d", __func__,
...
static inline void
__mpcomp_sendtosleep_mvp( mpcomp_mvp_t * mvp )
{
    /* Empty function */
}
...
__mpcomp_wakeup_node( int master, mpcomp_node_t * start_node, unsigned num_threads, mpcomp_instance_t* instance ) 
{
	int i ;
	mpcomp_node_t* n;
