...
static inline mpcomp_thread_t* mpcomp_thread_tls_store( mpcomp_thread_t* new_value )
{
    sctk_openmp_thread_tls = ( void* ) new_value;
    return new_value; 
}

static inline mpcomp_thread_t* mpcomp_thread_tls_swap( mpcomp_thread_t* new_value )
{
