...
#define global_errors privatise[__mpc_get_rank()].global_errors
#define a_errors privatise[__mpc_get_rank()].a_errors
#define b_errors privatise[__mpc_get_rank()].b_errors
