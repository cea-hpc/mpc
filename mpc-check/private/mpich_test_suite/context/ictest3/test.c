...
#define tests_passed privatise[__mpc_get_rank()].tests_passed
#define tests_failed privatise[__mpc_get_rank()].tests_failed
#define failed_tests privatise[__mpc_get_rank()].failed_tests
#define suite_name privatise[__mpc_get_rank()].suite_name
#define fileout privatise[__mpc_get_rank()].fileout
