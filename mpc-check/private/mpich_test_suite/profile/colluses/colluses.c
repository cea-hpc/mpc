...
#define used_send privatise[__mpc_get_rank()].used_send
#define used_isend privatise[__mpc_get_rank()].used_isend
#define used_sendrecv privatise[__mpc_get_rank()].used_sendrecv
