...
PROBE(INFINIBAND,MESSAGE_PASSING_INT,Infiniband module)

PROBE(ib_time_steals,INFINIBAND,ib_time_steals)

PROBE(ib_time_own,INFINIBAND,ib_time_steals)

PROBE(ib_time_ptp,INFINIBAND,ib_time_ptp)

PROBE(ib_time_coll,INFINIBAND,ib_time_coll)

PROBE(ib_time_send,INFINIBAND,ib_time_send)

PROBE(ib_poll_send,INFINIBAND,ib_poll_send)

PROBE(ib_poll_recv,INFINIBAND,ib_poll_recv)

PROBE(ib_post_send_lock,INFINIBAND,ib_post_send_lock)


PROBE(ib_post_send,INFINIBAND,ib_post_send)

PROBE(ib_resize_rdma,INFINIBAND,ib_resize_rdma)

PROBE(ib_get_numa,INFINIBAND,ib_get_numa)

PROBE(IBUF,INFINIBAND,Infiniband ibuf)

PROBE(ib_pick_send,IBUF,ib_pick_send)

PROBE(ib_pick_send_sr,IBUF,ib_pick_send_sr)

PROBE(ib_pick_recv,IBUF,ib_pick_recv)
...
PROBE(ib_poll_recv_ibuf,INFINIBAND,ib_poll_recv_ibuf)


COUNTER(ib_poll_steals,INFINIBAND,ib_poll_steals)
...
COUNTER(ib_poll_own,INFINIBAND,ib_poll_own)
...
COUNTER(ib_cp_matched,INFINIBAND,ib_cp_matched)

COUNTER(ib_cp_not_matched,INFINIBAND,ib_cp_not_matched)


COUNTER(ib_poll_found,INFINIBAND,ib_poll_found)

COUNTER(ib_poll_not_found,INFINIBAND,ib_poll_not_found)


COUNTER(ib_alloc_mem,INFINIBAND,ib_alloc_mem)

COUNTER(ib_free_mem,INFINIBAND,ib_free_mem)

COUNTER(ib_qp_created,INFINIBAND,ib_qp_created)

COUNTER(ib_eager_nb,INFINIBAND,ib_eager_nb)

COUNTER(ib_buffered_nb,INFINIBAND,ib_buffered_nb)

COUNTER(ib_rdma_nb,INFINIBAND,ib_rdma_nb)

COUNTER(ib_ibuf_sr_nb,INFINIBAND,ib_ibuf_sr_nb)

COUNTER(ib_ibuf_sr_size,INFINIBAND,ib_ibuf_sr_size)

COUNTER(ib_ibuf_rdma_nb,INFINIBAND,ib_ibuf_rdma_nb)
...
COUNTER(ib_rdma_resizing,INFINIBAND,ib_rdma_resizing)


COUNTER(ib_rdma_deconnection,INFINIBAND,ib_rdma_deconnection)


COUNTER(matching_found,INFINIBAND,matching_found)

COUNTER(matching_not_found,INFINIBAND,matching_not_found)


COUNTER(matching_locked,INFINIBAND,matching_locked)
...
PROBE(ib_ibuf_memcpy,INFINIBAND,ib_ibuf_memcpy)
...
PROBE(ib_rendezvous_wait_sender_done,INFINIBAND,ib_rendezvous_wait_sender_done)




PROBE(ib_rendezvous_wait_receiver_done,INFINIBAND,ib_rendezvous_wait_receiver_done)
...
PROBE(ib_rendezvous_recv_done_remote,INFINIBAND,ib_rendezvous_recv_done_remote)
...
PROBE(ib_rdma_idle,INFINIBAND,ib_rdma_idle)

PROBE(ib_poll_cq,INFINIBAND,ib_poll_cq)

PROBE(ib_perform_all,INFINIBAND,ib_perform_all)

PROBE(ib_cp_poll,INFINIBAND,ib_cp_poll)

PROBE(waitany_idle,INFINIBAND,waitany_idle)
