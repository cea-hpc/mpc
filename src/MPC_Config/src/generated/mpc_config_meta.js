...
meta.types = {
	...
	net_driver_infiniband : {type: 'struct', name: "net_driver_infiniband", childs: {
		...
		eager_limit: {mode: 'param', name: "eager_limit", type: "size", doc: "Size of the eager buffers (short messages).", dflt: "4KB", },
		buffered_limit: {mode: 'param', name: "buffered_limit", type: "size", doc: "Max size for using the Buffered protocol (message split into several Eager messages).", dflt: "48KB", },
		...
		max_inline: {mode: 'param', name: "max_inline", type: "size", doc: "Max size for inlining messages", dflt: "128B", },
		...
		init_ibufs: {mode: 'param', name: "init_ibufs", type: "int", doc: "Max number of Eager buffers to allocate during the initialization step", dflt: "1024", },
		init_recv_ibufs: {mode: 'param', name: "init_recv_ibufs", type: "int", doc: "Defines the number of receive buffers initially allocated. The number is on-the-fly expanded when needed (see init_recv_ibufs_chunk)", dflt: "1024", },
		...
		rdma_min_size: {mode: 'param', name: "rdma_min_size", type: "size", doc: "Defines the minimum size for the Eager RDMA buffers", dflt: "1KB", },
		rdma_max_size: {mode: 'param', name: "rdma_max_size", type: "size", doc: "Defines the maximun size for the Eager RDMA buffers", dflt: "4KB", },
		...
		rdma_resizing_min_size: {mode: 'param', name: "rdma_resizing_min_size", type: "size", doc: "Defines the minimum size for the Eager RDMA buffers (resizing)", dflt: "1KB", },
		rdma_resizing_max_size: {mode: 'param', name: "rdma_resizing_max_size", type: "size", doc: "Defines the maximum size for the Eager RDMA buffers (resizing)", dflt: "4KB", },
	...
	collectives_intra : {type: 'struct', name: "collectives_intra", childs: {
		...
		reduce_intra_for_trsh: {mode: 'param', name: "reduce_intra_for_trsh", type: "int", doc: "Maximum number of process for using a trivial for for the Reduce", dflt: "33", },
		reduce_intra_for_count_trsh: {mode: 'param', name: "reduce_intra_for_count_trsh", type: "int", doc: "Maximum number of elements for using a trivial for for the Reduce", dflt: "1024", },
	...
	openmp : {type: 'struct', name: "openmp", childs: {
		...
		omp_new_task_depth: {mode: 'param', name: "omp_new_task_depth", type: "int", doc: "Depth of the new tasks lists in the tree", dflt: "10", },
		omp_untied_task_depth: {mode: 'param', name: "omp_untied_task_depth", type: "int", doc: "Depth of the untied tasks lists in the tree", dflt: "10", },
		omp_task_larceny_mode: {mode: 'param', name: "omp_task_larceny_mode", type: "mpcomp_task_larceny_mode_t", doc: "Task stealing policy", dflt: "MPCOMP_TASK_LARCENY_MODE_PRODUCER", },
		omp_task_nesting_max: {mode: 'param', name: "omp_task_nesting_max", type: "int", doc: "Task max depth in task generation", dflt: "1000000", },
		mpcomp_task_max_delayed: {mode: 'param', name: "mpcomp_task_max_delayed", type: "int", doc: " Max tasks in mpcomp list", dflt: "1024", },
		omp_task_steal_last_stolen_list: {mode: 'param', name: "omp_task_steal_last_stolen_list", type: "bool", doc: "Try to steal to same list than last successful stealing", dflt: "false", },
...
meta.enum = {
	...
	mpcomp_task_larceny_mode_t : {type: 'enum', name: "mpcomp_task_larceny_mode_t", doc: "", values: {
		...
		MPCOMP_TASK_LARCENY_MODE_HIERARCHICAL_RANDOM: "MPCOMP_TASK_LARCENY_MODE_HIERARCHICAL_RANDOM",
