...
static inline int *__tree_array_compute_first_children( mpc_omp_node_t *root, mpc_omp_node_t *node )
{
...
static inline int *__tree_array_compute_parents(  mpc_omp_node_t *root, mpc_omp_node_t *node )
{
